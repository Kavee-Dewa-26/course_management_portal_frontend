...
import { REGISTRATIONS_SEED } from "@/lib/mock/registrations";
...
export default function AdminRegistrationsPage() {
  ...
  const handleExport = () => {
    ...
    const rows = visibleRows.map((r) => [r.name, r.email, r.country, r.date, r.status]);
      ...
      <div className="page-header">
        <div>
          ...
          <div className="greeting">
            <b style={{ color: "#152A24" }}>{pending}</b> awaiting approval. Once approved, the
            learner can sign in and request course access.
          </div>
        </div>
